...
var ProtoEnum = function (props) {
  ...
  var ValueRows = function () {
    return react_1.default.createElement(
      "tbody",
      null,
      enumb.values.map(function (enumValue) {
        return react_1.default.createElement(
          "tr",
          { key: enumValue.name },
          react_1.default.createElement(
...
var ProtoServiceMethods = function (props) {
  ...
  return react_1.default.createElement(
    ...
    methods.map(function (method, i) {
      return react_1.default.createElement(exports.ProtoServiceMethod, {
        method: method,
        key: method.name + "-" + i,
      });
    })
...
var ProtoService = function (props) {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(ProtoServiceMethods, {
...
var ProtoMessage = function (props) {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(ProtoMessageFields, {
...
var ProtoFile = function (props) {
  var fileDescriptor = props.fileDescriptor,
  ...
  return react_1.default.createElement(
    ...
    fileDescriptor.messages.map(function (message, i) {
      return react_1.default.createElement(exports.ProtoMessage, {
        message: message,
        key: i,
      });
    })
