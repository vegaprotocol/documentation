...
#### `remaining` ([`String!`](/graphql/scalars/string))
...
#### `expiresAt` ([`String`](/graphql/scalars/string))

Expiration time of this order (ISO-8601 RFC3339+Nano formatted date)

#### `status` ([`OrderStatus!`](/graphql/enums/order-status))
...
#### `rejectionReason` ([`OrderRejectionReason`](/graphql/enums/order-rejection-reason))
...
#### `peggedOrder` ([`PeggedOrder`](/graphql/objects/pegged-order))

PeggedOrder contains the details about a pegged order

#### `liquidityProvision` ([`LiquidityProvision`](/graphql/objects/liquidity-provision))
