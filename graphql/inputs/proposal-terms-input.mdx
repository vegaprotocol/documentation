...
#### `newMarket` ([`NewMarketInput`](/graphql/inputs/new-market-input))
...
#### `updateMarket` ([`UpdateMarketInput`](/graphql/inputs/update-market-input))
...
#### `updateNetworkParameter` ([`UpdateNetworkParameterInput`](/graphql/inputs/update-network-parameter-input))
...
#### `newAsset` ([`NewAssetInput`](/graphql/inputs/new-asset-input))
