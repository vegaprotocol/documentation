...
```
vega nodewallet import --chain=vega --home="YOUR_HOME_PATH" --wallet-passphrase-file="file/containing/account/passphrase" --wallet-path="PATH_FOR_YOUR_WALLET_HOME"
```

Alternatively you can create a new Vega wallet and save it in the node wallet:
```
vega nodewallet generate --chain=vega --home="YOUR_HOME_PATH" --wallet-passphrase-file="file/containing/account/passphrase"
```

:::info
You can verify the information saved in your node wallet using the following command:
```
vega nodewallet --home="YOUR_HOME_PATH" show 
```
:::
...
```
vega nodewallet import --chain=tendermint --home="YOUR_HOME_PATH" --tendermint-home="YOUR_TENDERMINT_HOME_PATH"
```
