...
This guide describes the steps to upgrade to 0.70.1 using a checkpoint. This upgrade includes a fix to `time_iota_ms` in the genesis file. Find the right page in the [release notes for v0.70.1](https://github.com/vegaprotocol/documentation/blob/main/docs/releases/overview.md#pre-release-versions-0700-and-0701-combined--2023-03-28)
