...
This guide describes the steps to upgrade to 0.70.2 using a checkpoint. See the [release notes for v0.70](https://github.com/vegaprotocol/documentation/blob/main/docs/releases/overview.md#pre-release-versions-0700-and-0701-combined--2023-03-28) for information about breaking changes and other details.
