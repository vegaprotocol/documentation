---
sidebar_position: 2
title: Data node nfrastructure guidance
...
Data node operators who are running a data node to support their own needs can run a leaner set-up depending on their own requirements.

Those data node operators running archive nodes, which retain all chain information, will need a more robust set-up.
