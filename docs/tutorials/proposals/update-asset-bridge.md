...
First, you must have the change approved by the given network through governance, using a [new asset proposal](./new-asset-proposal.md)
...
### 1. Confirm asset proposal has passed
First, you must have the change approved by the given network through governance, using an [update asset proposal](./update-asset-proposal.md). Unlike New Asset proposals, the asset ID doesn't change as a result, so you already have the asset ID you need in step 3.
