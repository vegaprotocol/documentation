...
* Familiarity with [governance on Vega](../../concepts/vega-protocol/governance.md), particularly [network parameter governance](../../concepts/vega-protocol/governance.md#network-parameter-governance)
