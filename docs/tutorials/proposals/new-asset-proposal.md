...
* Familiarity with [governance on Vega](../../concepts/vega-protocol/governance.md), particularly [assets at a protocol level](../../concepts/vega-protocol/governance#asset-governance)
- After a new asset vote passes, the change has to be submitted to the [asset bridge](../../concepts/vega-protocol/assets.md#asset-bridges) on Ethereum. Until it has been submitted, no one can start depositing that asset.
