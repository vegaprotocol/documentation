...
class VegaWebSocketClient:
    ...
    # https://docs.vega.xyz/pre-release/api/rest/data-v2/trading-data-service-observe-markets-data
    ...
    # https://docs.vega.xyz/pre-release/api/rest/data-v2/trading-data-service-observe-orders
    ...
    # https://docs.vega.xyz/pre-release/api/rest/data-v2/trading-data-service-observe-positions
    ...
    # https://docs.vega.xyz/pre-release/api/rest/data-v2/trading-data-service-observe-accounts
