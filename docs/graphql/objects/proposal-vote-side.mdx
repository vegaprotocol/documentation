...
#### `votes` ([`[Vote!]`](/docs/graphql/objects/vote))

All votes casted for this side

#### `totalNumber` ([`String!`](/docs/graphql/scalars/string))

Total number of votes casted for this side

#### `totalWeight` ([`String!`](/docs/graphql/scalars/string))

Total weight of governance token from the votes casted for this side

#### `totalTokens` ([`String!`](/docs/graphql/scalars/string))
