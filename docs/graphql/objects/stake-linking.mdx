...
#### `type` ([`StakeLinkingType!`](/docs/graphql/enums/stake-linking-type))
...
#### `status` ([`StakeLinkingStatus!`](/docs/graphql/enums/stake-linking-status))

The status of the linking

#### `finalizedAt` ([`String`](/docs/graphql/scalars/string))
