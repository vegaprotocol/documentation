...
#### `openVolume` ([`String!`](/docs/graphql/scalars/string))

Open volume (uint64)

#### `realisedPNL` ([`String!`](/docs/graphql/scalars/string))

Realised Profit and Loss (int64)

#### `unrealisedPNL` ([`String!`](/docs/graphql/scalars/string))

Unrealised Profit and Loss (int64)

#### `averageEntryPrice` ([`String!`](/docs/graphql/scalars/string))
