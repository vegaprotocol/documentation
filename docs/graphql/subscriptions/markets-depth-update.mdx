...
#### [<code style={{ fontWeight: 'normal' }}>marketsDepthUpdate.<b>marketIds</b></code>](#)<Bullet />[`[ID!]!`](/docs/testnet/graphql/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
> ID of the market you want to receive market depth price level updates for
> 

### Type

#### [`ObservableMarketDepthUpdate`](/docs/testnet/graphql/objects/observable-market-depth-update) <Badge class="secondary" text="object"/>
