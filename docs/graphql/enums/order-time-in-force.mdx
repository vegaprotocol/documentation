...
[`estimateOrder`](/docs/testnet/graphql/queries/estimate-order)  <Badge class="secondary" text="query"/><Bullet />[`Order`](/docs/testnet/graphql/objects/order)  <Badge class="secondary" text="object"/><Bullet />[`OrderUpdate`](/docs/testnet/graphql/objects/order-update)  <Badge class="secondary" text="object"/>
