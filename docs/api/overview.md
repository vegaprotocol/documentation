...
:::note Go deeper
* **[Overview: Transactions for trading](./useful-endpoints.md)**: See the commonly used transactions for trading.
...
* **[Public servers](./public-servers.md)**: Public endpoints that are currently available for interacting with the APIs on the testnets.
