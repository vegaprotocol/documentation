...
#### [<code style={{ fontWeight: 'normal' }}>newFreeformProposals.<b>inState</b></code>](#)<Bullet />[`ProposalState`](/testnet/api/graphql/enums/proposal-state) <Badge class="secondary" text="enum"/>
