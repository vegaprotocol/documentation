...
#### [<code style={{ fontWeight: 'normal' }}>getMarketDataHistoryConnectionByID.<b>id</b></code>](#)<Bullet />[`ID!`](/testnet/api/graphql/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
> 
> 

#### [<code style={{ fontWeight: 'normal' }}>getMarketDataHistoryConnectionByID.<b>start</b></code>](#)<Bullet />[`Timestamp`](/testnet/api/graphql/scalars/timestamp) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>getMarketDataHistoryConnectionByID.<b>end</b></code>](#)<Bullet />[`Timestamp`](/testnet/api/graphql/scalars/timestamp) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>getMarketDataHistoryConnectionByID.<b>pagination</b></code>](#)<Bullet />[`Pagination`](/testnet/api/graphql/inputs/pagination) <Badge class="secondary" text="input"/>
> Optional Pagination
> 
