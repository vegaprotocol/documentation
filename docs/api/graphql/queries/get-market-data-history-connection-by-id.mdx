...
#### [<code style={{ fontWeight: 'normal' }}>getMarketDataHistoryConnectionByID.<b>start</b></code>](#)<Bullet />[`Int`](/testnet/api/graphql/scalars/int) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>getMarketDataHistoryConnectionByID.<b>end</b></code>](#)<Bullet />[`Int`](/testnet/api/graphql/scalars/int) <Badge class="secondary" text="scalar"/>
