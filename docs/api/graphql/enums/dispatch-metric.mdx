...
#### [<code style={{ fontWeight: 'normal' }}>DispatchMetric.<b>DISPATCH_METRIC_AVERAGE_POSITION</b></code>](#) 
> Dispatch metric that uses the time weighted position of the party in the market
> 

#### [<code style={{ fontWeight: 'normal' }}>DispatchMetric.<b>DISPATCH_METRIC_RELATIVE_RETURN</b></code>](#) 
> Dispatch metric that uses the relative PNL of the party in the market
> 

#### [<code style={{ fontWeight: 'normal' }}>DispatchMetric.<b>DISPATCH_METRIC_RETURN_VOLATILITY</b></code>](#) 
> Dispatch metric that uses return volatility of the party in the market
> 

#### [<code style={{ fontWeight: 'normal' }}>DispatchMetric.<b>DISPATCH_METRIC_VALIDATOR_RANKING</b></code>](#) 
