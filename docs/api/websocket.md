...
Vega's API contains WebSocket endpoints that offer real-time updates to state changes, allowing subscriptions to events such as per-market trades or changes to a party's position.
