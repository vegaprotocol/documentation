---
id: trading-data-service-v-1-network-parameters
title: "Get the network parameters"
description: "Get the network parameters"
sidebar_label: Get the network parameters
hide_title: true
hide_table_of_contents: true
api: {"operationId":"Trading Data Service (v1)_NetworkParameters","responses":{"200":{"description":"A successful response.","content":{"application/json":{"schema":{"type":"object","properties":{"networkParameters":{"type":"array","items":{"type":"object","properties":{"key":{"type":"string","title":"The unique key"},"value":{"type":"string","title":"The value for the network parameter"}},"title":"Represents a network parameter on Vega"}}},"title":"A response containing all of the vega network parameters"}}}},"default":{"description":"An unexpected error response.","content":{"application/json":{"schema":{"type":"object","properties":{"code":{"type":"integer","format":"int32"},"message":{"type":"string"},"details":{"type":"array","items":{"type":"object","properties":{"@type":{"type":"string"}},"additionalProperties":{}}}}}}}}},"tags":["Trading Data Service (v1)"],"description":"Get the network parameters","method":"get","path":"/network/parameters","servers":[{"url":"http://api.n10.vega.xyz"},{"url":"https://api.n10.vega.xyz"}],"info":{"title":"data-node/api/v1/trading_data.proto","version":"0.56.0"},"postman":{"name":"Get the network parameters","description":{"type":"text/plain"},"url":{"path":["network","parameters"],"host":["{{baseUrl}}"],"query":[],"variable":[]},"header":[{"key":"Accept","value":"application/json"}],"method":"GET"}}
