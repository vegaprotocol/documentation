...
When choosing a Vega Wallet software version, ensure it is compatible with the network version number you're using, as mainnet and testnet may not be using the same software version.
:::
