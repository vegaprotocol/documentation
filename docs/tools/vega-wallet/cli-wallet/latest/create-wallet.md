...
These instructions cover Vega Wallet version 0.63.1, which is only compatible with Vega network(s) that are also on v0.63.1. If  you need a Vega Wallet for mainnet, see [Create a wallet (mainnet)](https://docs.vega.xyz/docs/mainnet/tools/vega-wallet/cli-wallet/latest/create-wallet).
:::
