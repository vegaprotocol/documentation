...
:::caution
These instructions cover Vega Wallet version 0.58, which is only compatible with Vega network(s) that are also on v0.58. If  you need a Vega Wallet for mainnet, see [Create a wallet (mainnet)](https://docs.vega.xyz/docs/mainnet/tools/vega-wallet/cli-wallet/latest/create-wallet).
:::
