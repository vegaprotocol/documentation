...
These instructions cover Vega Wallet version 0.71.4, which is compatible with Vega network(s) that are on v0.71.4. If you need a Vega Wallet for mainnet, see [Create a wallet (mainnet)](https://docs.vega.xyz/docs/mainnet/tools/vega-wallet/cli-wallet/latest/create-wallet).
:::
