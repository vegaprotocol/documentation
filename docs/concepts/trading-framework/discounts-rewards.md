...
Users can offset some of the [fees](./fees.md) they pay, or earn even more, by receiving rewards based on trading activity. Rewards can be funded by anyone, and can be in any asset.
...
Members of a team can switch to a different team by using the team's referral code.
