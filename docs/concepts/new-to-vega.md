...
Alpha mainnet is the second decentralised version of the Vega network. The second step of a three-stage launch process, and will be followed by v1 mainnet.
