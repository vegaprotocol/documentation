...
To use assets, for example to take part in markets, you'll need to deposit them: 
...
* After approving, choose an amount to deposit. This deposit will have to accepted on the Ethereum network and the other network before the assets can be used
...
To remove assets from the network, submit a withdrawal request using [Etherscan](../../tutorials/assets-tokens/withdrawing-assets.md). 
