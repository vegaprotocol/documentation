...
You can offset some of the [fees](./fees.md) you pay, or earn even more, by receiving rewards based on trading activity. Rewards can be funded by anyone, and can be in any asset. You can see what rewards are currently available on [Console ↗](https://console.vega.xyz/#/rewards).
...
:::tip Refer a friend
Get benefits for referring, or being referred. In the [referrals section of Console](https://console.vega.xyz/#/referrals), you can:
