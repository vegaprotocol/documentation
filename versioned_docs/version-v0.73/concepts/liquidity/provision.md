...
:::tip Try it out
[Tutorial: Commit liquidity](../../tutorials/building-a-bot/adding-a-liquidity-commitment.md): See sample bot code for setting up and managing a liquidity commitment.
:::
...
:::tip Query for data
[API: Market data for target stake](./api/../../../api/rest/data-v2/trading-data-service-get-latest-market-data.api.mdx)
:::
...
:::note Go deeper
* [Spec: Target stake calculations ↗](https://github.com/vegaprotocol/specs/blob/master/protocol/0041-TSTK-target_stake.md)
