...
#### `openVolume` ([`String`](/docs/v0.47/graphql/scalars/string))

Open volume (uint64)


#### `realisedPNL` ([`String`](/docs/v0.47/graphql/scalars/string))

Realised Profit and Loss (int64)


#### `unrealisedPNL` ([`String`](/docs/v0.47/graphql/scalars/string))

Unrealised Profit and Loss (int64)


#### `averageEntryPrice` ([`String`](/docs/v0.47/graphql/scalars/string))
