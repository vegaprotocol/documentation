...
#### `timestamp` ([`Timestamp`](/docs/graphql/scalars/timestamp))
...
#### `accountId` ([`String`](/docs/graphql/scalars/string))
...
#### `marketId` ([`String`](/docs/graphql/scalars/string))

Market identifier, if query was grouped by market - else null


#### `accountType` ([`AccountType`](/docs/graphql/enums/account-type))
