...
#### `timestamp` ([`Timestamp`](/docs/v0.47/graphql/scalars/timestamp))
...
#### `accountId` ([`String`](/docs/v0.47/graphql/scalars/string))
...
#### `assetId` ([`String`](/docs/v0.47/graphql/scalars/string))

Asset identifier, if query was grouped by asset - else null


#### `marketId` ([`String`](/docs/v0.47/graphql/scalars/string))

Market identifier, if query was grouped by market - else null


#### `accountType` ([`AccountType`](/docs/v0.47/graphql/enums/account-type))
