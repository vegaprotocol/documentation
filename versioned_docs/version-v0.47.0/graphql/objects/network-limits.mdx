...
#### `canProposeMarket` ([`Boolean`](/docs/v0.47/graphql/scalars/boolean))

Are market proposals allowed at this point in time


#### `canProposeAsset` ([`Boolean`](/docs/v0.47/graphql/scalars/boolean))

Are asset proposals allowed at this point in time


#### `bootstrapFinished` ([`Boolean`](/docs/v0.47/graphql/scalars/boolean))

True once block count &#x003E; bootstrapBlockCount


#### `proposeMarketEnabled` ([`Boolean`](/docs/v0.47/graphql/scalars/boolean))

Are market proposals enabled on this chain


#### `proposeAssetEnabled` ([`Boolean`](/docs/v0.47/graphql/scalars/boolean))

Are asset proposals enabled on this chain


#### `bootstrapBlockCount` ([`Int`](/docs/v0.47/graphql/scalars/int))

How many blocks before the chain comes out of bootstrap mode


#### `genesisLoaded` ([`Boolean`](/docs/v0.47/graphql/scalars/boolean))

True once the genesis file is loaded


#### `proposeMarketEnabledFrom` ([`Timestamp`](/docs/v0.47/graphql/scalars/timestamp))

The date/timestamp in unix nanoseconds at which market proposals will be enabled (0 indicates not set)


#### `proposeAssetEnabledFrom` ([`Timestamp`](/docs/v0.47/graphql/scalars/timestamp))
