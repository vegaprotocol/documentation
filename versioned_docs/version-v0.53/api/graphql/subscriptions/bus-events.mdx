...
#### [`types`](#) ([`[BusEventType!]!`](/mainnet/api/graphql/enums/bus-event-type))
...
#### [`batchSize`](#) ([`Int!`](/mainnet/api/graphql/scalars/int))
...
#### [`BusEvent`](/mainnet/api/graphql/objects/bus-event)
