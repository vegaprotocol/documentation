...
#### [`start`](#) ([`Int`](/mainnet/api/graphql/scalars/int))
...
#### [`end`](#) ([`Int`](/mainnet/api/graphql/scalars/int))
...
#### [`MarketDataConnection`](/mainnet/api/graphql/objects/market-data-connection)
