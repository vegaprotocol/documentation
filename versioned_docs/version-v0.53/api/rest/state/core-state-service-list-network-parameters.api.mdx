...
api: {"operationId":"CoreStateService_ListNetworkParameters","responses":{"200":{"description":"A successful response.","content":{"application/json":{"schema":{"type":"object","properties":{"networkParameters":{"type":"array","items":{"type":"object","properties":{"key":{"type":"string","title":"The unique key"},"value":{"type":"string","title":"The value for the network parameter"}},"title":"Represents a network parameter on Vega"}}}}}}},"default":{"description":"An unexpected error response.","content":{"application/json":{"schema":{"type":"object","properties":{"code":{"type":"integer","format":"int32"},"message":{"type":"string"},"details":{"type":"array","items":{"type":"object","properties":{"@type":{"type":"string"}},"additionalProperties":{}}}}}}}}},"parameters":[{"name":"networkParameterKey","in":"query","required":false,"schema":{"type":"string"}}],"tags":["CoreStateService"],"description":"CoreStateService_ListNetworkParameters","method":"get","path":"/network/parameters","servers":[{"url":"http://api.n10.vega.xyz"},{"url":"https://api.n10.vega.xyz"}],"info":{"title":"vega/api/v1/corestate.proto","version":"version not set"},"postman":{"name":"Core State Service List Network Parameters","description":{"type":"text/plain"},"url":{"path":["network","parameters"],"host":["{{baseUrl}}"],"query":[{"disabled":false,"key":"networkParameterKey","value":""}],"variable":[]},"header":[{"key":"Accept","value":"application/json"}],"method":"GET"}}
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Query Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"networkParameterKey","in":"query","required":false,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
