---
id: trading-data-service-fee-infrastructure-accounts
sidebar_label: Get a list of accounts holding infrastructure fees.
hide_title: true
hide_table_of_contents: true
api:
  {
    "operationId": "TradingDataService_FeeInfrastructureAccounts",
    "responses":
      {
        "200":
          {
    ...
    "method": "get",
    "path": "/assets/{asset}/infrastructureFeeAccount",
    "info":
      {
    ...
    "postman":
      {
        "name": "Get a list of accounts holding infrastructure fees.\nCan be filtered by asset, there will be 1 infrastructure fee account per\nasset in the network.",
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) Asset identifier, required field\n- Set to an empty string to return all accounts\n- Set to an asset ID to return a single infrastructure fee account for a given asset",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
