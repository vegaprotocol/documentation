...
- [Network state](../../category/api/rest/core/core-service): Get information about the network, such as 'block height' and 'Vega time'.
...
- [Data node](../../category/api/rest/data-v1/trading-data-service): Get historic information and cumulative data, such as 'governance data for all proposals'
