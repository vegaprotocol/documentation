...
* A participant cannot send more delegation transactions per day than the max set by the <NetworkParameter frontMatter={frontMatter} param="spam.protection.max.delegations" /> network parameter
