...
#### [`data`](#) ([`[Property!]`](/docs/mainnet/graphql/objects/property))

data contains all the properties send by an oracle


#### [`matchedSpecIds`](#) ([`[String!]`](/docs/mainnet/graphql/scalars/string))
...
#### [`broadcastAt`](#) ([`String!`](/docs/mainnet/graphql/scalars/string))
