...
#### [`start`](#) ([`Int`](/docs/mainnet/graphql/scalars/int))
...
#### [`end`](#) ([`Int`](/docs/mainnet/graphql/scalars/int))
...
#### [`MarketDataConnection`](/docs/mainnet/graphql/objects/market-data-connection)
