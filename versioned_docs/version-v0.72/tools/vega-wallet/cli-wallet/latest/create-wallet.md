...
These instructions cover Vega Wallet version 0.72.14, which is compatible with Vega network(s) that are on v0.72.14. If you need a Vega Wallet for testnet, see [Create a wallet (testnet)](https://docs.vega.xyz/docs/testnet/tools/vega-wallet/cli-wallet/latest/create-wallet).
:::
