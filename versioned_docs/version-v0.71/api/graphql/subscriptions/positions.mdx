...
#### [<code style={{ fontWeight: 'normal' }}>positions.<b>partyId</b></code>](#)<Bullet />[`ID`](/mainnet/api/graphql/scalars/id) <Badge class="secondary" text="scalar"/>
> ID of the party from you want updates for
> 

#### [<code style={{ fontWeight: 'normal' }}>positions.<b>marketId</b></code>](#)<Bullet />[`ID`](/mainnet/api/graphql/scalars/id) <Badge class="secondary" text="scalar"/>
> ID of the market from which you want position updates
> 

### Type

#### [`PositionUpdate`](/mainnet/api/graphql/objects/position-update) <Badge class="secondary" text="object"/>
