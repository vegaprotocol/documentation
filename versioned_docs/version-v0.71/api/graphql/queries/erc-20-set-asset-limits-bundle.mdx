...
#### [<code style={{ fontWeight: 'normal' }}>erc20SetAssetLimitsBundle.<b>proposalId</b></code>](#)<Bullet />[`ID!`](/mainnet/api/graphql/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
> ID of the proposal to update an asset
> 

### Type

#### [`ERC20SetAssetLimitsBundle`](/mainnet/api/graphql/objects/erc20-set-asset-limits-bundle) <Badge class="secondary" text="object"/>
