...
[`RankingScore`](/mainnet/api/graphql/objects/ranking-score)  <Badge class="secondary" text="object"/><Bullet />[`RewardScore`](/mainnet/api/graphql/objects/reward-score)  <Badge class="secondary" text="object"/>
