...
You can retrieve the signature bundle, which you will submit to the ERC20 bridge in the next step, by using the [REST](../../api/rest/data-v2/trading-data-service-list-withdrawals).
